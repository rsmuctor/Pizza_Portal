...
<div class="main_content">
  <div class="wrapper">
    ...
    <h1 class="text_center">Desserts</h1>
    ...
    $sql = "SELECT * FROM food_table WHERE category='desserts' AND featured='Yes'";
    // Execute the query
    $res = mysqli_query($conn, $sql);
    // Count the rows
    $count = mysqli_num_rows($res);

    // Check if the desserts are available
    if($count > 0) {
      ...
      // Desserts are not available
      echo "<div class='failed text_center'>❌ Display Desserts Failed!<br /><br />⚠️ No Desserts Added!</div>";
    }
    ?>
