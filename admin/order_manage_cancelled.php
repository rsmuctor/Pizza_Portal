...
<div class="main_content">
  <div class="wrapper">
    ...
    <h1 class="text_center">Order Management: Cancelled</h1>
    ...
    <!-- Add the all orders button --->
    <a href="order_manage.php" class="button10">📑 All Orders</a>
    ...
    <table class="full_table">
      ...
      $sql = "SELECT * FROM order_table WHERE status = 'Cancelled' ORDER BY id DESC"; // Display only cancelled orders
      // Execute the query
      ...
      if($count > 0) {
        ...
        while($rows=mysqli_fetch_assoc($res)) {
          ...
          ?>
          <tr>
            <td colspan="10"><h4 class='failed text_center'>❌ Display Cancelled Orders Failed! ⚠️ No Cancelled Orders Added!</h4></td>
          </tr>
          <?php
        }
