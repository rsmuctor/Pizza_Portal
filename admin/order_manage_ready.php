...
<div class="main_content">
  <div class="wrapper">
    ...
    <h1 class="text_center">Order Management: Ready</h1>
    ...
    <table class="full_table">
      ...
      $sql = "SELECT * FROM order_table WHERE status = 'Ready' ORDER BY id DESC"; // Display only ready orders
      // Execute the query
      ...
      if($count > 0) {
        ...
        while($rows=mysqli_fetch_assoc($res)) {
          ...
          ?>
          <tr>
            <td colspan="10"><h4 class='failed text_center'>❌ Display Ready Orders Failed! ⚠️ No Ready Orders Added!</h4></td>
          </tr>
          <?php
        }
